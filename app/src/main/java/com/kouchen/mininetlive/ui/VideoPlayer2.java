 ...
 * On 2016/04/18 16:15
 */
public class VideoPlayer2 extends JCVideoPlayer implements JCMediaManager.JCMediaPlayerListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (mCurrentState == CURRENT_STATE_NORMAL) {
                if (!NetUtil.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
