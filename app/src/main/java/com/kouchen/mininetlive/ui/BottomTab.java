...
public class BottomTab extends LinearLayout implements BottomTabImpl {
	...
	public BottomTab(Context context, AttributeSet attrs) {
		...
		try {
			...
			mTabTextColors = tTypedArray.getColorStateList(R.styleable.BottomTab_bottomTabTextColor);
			mTabTitle = tTypedArray.getText(R.styleable.BottomTab_bottomTabText);
			mTabTitleSize = tTypedArray.getDimensionPixelSize(R.styleable.BottomTab_bottomTabTextSize, DEFAULT_TITLE_TEXT_SIZE);
